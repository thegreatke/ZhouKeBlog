    ...
    function putInArticle(data) {
        ...
        var articleTop = $('<article-top><div class="article-title">' +
            ...
            '多年以后，愿你的城市，有清风，有烈酒，也有人是你的归途。<span class="article-i-say-me">--- 周轲</span>' +
            '</div>');
        ...
        var articleFooter = $('<div class="end-logo">' +
            ...
            '<img src="http://zk-blog-picture.oss-cn-shanghai.aliyuncs.com/blog_picture/mmqrcode1552309205443.png">' +
            '</p>' +
            '<p class="show-weixin-pic">欢迎关注我的微信：zhouke990509</p>' +
