    ...
    //网站最后更新时间（版本更新需更改）
    var siteLastUpdateTime = '2019年03月16日14点';

    //网站开始时间
    var siteBeginRunningTime = '2019-03-15 20:00:00';
    ...
    $('.myCardBtn').click(function () {
        $('.qq_code').attr("src","https://zk-blog-picture.oss-cn-shanghai.aliyuncs.com/blog_picture/qrcode_1552309192027.jpg");
        $('.weixin_code').attr("src","https://zk-blog-picture.oss-cn-shanghai.aliyuncs.com/blog_picture/mmqrcode1552309205443.png");
    });
